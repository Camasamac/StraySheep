...
func save_game():
	...
	var data: Dictionary = {
		"PlayerPositionX": Global.PlayerPosition_X,
		"PlayerPositionY": Global.PlayerPosition_Y,
...
func load_game():
	...
	while not save_game.eof_reached():
		...
		if current_line:
			Global.PlayerPosition_X = current_line["PlayerPositionX"]
			Global.PlayerPosition_Y = current_line["PlayerPositionY"]
			Global.FirstLaunch = current_line["FirstLaunch"]
